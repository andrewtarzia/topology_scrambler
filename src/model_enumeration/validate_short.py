...
def main() -> None:  # noqa: PLR0915
    ...
    calculation_dir = wd / "ivalidations_calculations"
    calculation_dir.mkdir(exist_ok=True)
    structure_dir = wd / "ivalidations_structures"
    structure_dir.mkdir(exist_ok=True)
    ligand_dir = wd / "ivalidations_ligands"
    ligand_dir.mkdir(exist_ok=True)
    data_dir = wd / "ivalidations_data"
    data_dir.mkdir(exist_ok=True)
    figure_dir = wd / "figures"
    figure_dir.mkdir(exist_ok=True)

    database_path = data_dir / "ivalidations_run.db"
    timing_file = data_dir / "ivalidations_times.csv"
    ...
    make_timings_plot(
        ...
        figure_dir=figure_dir,
        filename="validations_times.png",
    )
    make_summary_plot(
        database_path=database_path,
        figure_dir=figure_dir,
        filename="validations_2.png",
    )
