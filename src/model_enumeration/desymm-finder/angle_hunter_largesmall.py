...
from env_set import EnvVariables, stoich_map
from rdkit import RDLogger
from utilities import create_zone, get_forcefield_dict, get_potential_bb_dicts
...
def main() -> None:
    ...
    kt2bnbzones = {"4P6": create_zone(dmin=70, dmax=115, resolution=2)}
    kt2baczones = {"4P6": create_zone(dmin=100, dmax=150, resolution=2)}

    kt1bmbzones = {"6P12": create_zone(dmin=50, dmax=85, resolution=2)}
    kt1baczones = {"6P12": create_zone(dmin=110, dmax=145, resolution=2)}
    ...
    studies = {
        ...
        "kt1r1_6P12": {
            ...
            "definer_dict_updates": {
                "bmb": ("pyramid", kt1bmbzones["6P12"], 1e2),
                "byb": ("pyramid", 90, 1e2),
                "bac": ("angle", kt1baczones["6P12"], 1e2),
            },
            "bb_type": "tetratopic",
        },
        "kt2_4P6": {
        ...
        "kt2r1_4P6": {
            ...
            "bb_ratio": (1, 1),
            "definer_dict_updates": {
                "bnb": ("angle", kt2bnbzones["4P6"], 1e2),
                "bxb": ("angle", 120, 1e2),
                "bac": ("angle", kt2baczones["4P6"], 1e2),
            },
            "bb_type": "tritopic",
        },
    }
    ...
    for study in studies:
        ...
        possible_bbdicts = get_potential_bb_dicts(
